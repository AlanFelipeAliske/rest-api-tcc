...
class CoreCoreidiomas(models.Model):
    id = models.BigAutoField(primary_key=True)
    idiomas_descri = models.CharField(max_length=100)

    class Meta:
        managed = False
        db_table = 'core_coreidiomas'


class CoreCoreperguntas(models.Model):
    id = models.BigAutoField(primary_key=True)
    perguntas_descri = models.CharField(max_length=255)
    idioma = models.ForeignKey(CoreCoreidiomas, models.DO_NOTHING, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'core_coreperguntas'


class CoreCoreposts(models.Model):
    id = models.BigAutoField(primary_key=True)
    post_titulo = models.CharField(max_length=100)
    post_descricao = models.CharField(max_length=255)
    post_conteudo = models.TextField()
    ...
    class Meta:
        managed = False
        db_table = 'core_coreposts'


class CoreCorerespostas(models.Model):
    id = models.BigAutoField(primary_key=True)
    nome = models.CharField(max_length=255)
    pais_de_origem = models.CharField(max_length=255)
    tempo_no_brasil = models.CharField(max_length=255)
    ...
    dificuldade_imigrante = models.CharField(max_length=255)
    idioma = models.ForeignKey(CoreCoreidiomas, models.DO_NOTHING, blank=True, null=True)
    pergunta = models.ForeignKey(CoreCoreperguntas, models.DO_NOTHING, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'core_corerespostas'
