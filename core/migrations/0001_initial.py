# Generated by Django 4.0.5 on 2022-11-28 18:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idioma', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.idiomas')),
                ('pergunta', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.perguntas')),
            ],
        ),
        migrations.CreateModel(
            name='Posts',
